function nw_networkManagerBase_test() : GMLTest_Harness() constructor {
	entity = pointer_null;
...
test_f(nw_networkManagerBase_test, "nw_network_manager create instance should work", function() {
